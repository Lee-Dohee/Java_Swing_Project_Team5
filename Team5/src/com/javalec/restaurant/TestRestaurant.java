...
public class TestRestaurant {
	...
	public TestRestaurant(int wkNum) {
		this.wkNum = wkNum;
		initialize();
	}
	...
	private void restaurantInfo() {
		...
		String wkNumS = Integer.toString(wkNum);
		// restaurant 기본 정보 불러오기
		BeanRestrant beanRestrantInfo = dbActionRestrant.restaurantInfo(wkNumS);
		...
		String star = dbActionRestrant.restaurantStar(wkNumS);
