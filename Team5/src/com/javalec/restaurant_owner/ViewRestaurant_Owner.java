...
public class ViewRestaurant_Owner {
	...
	public ViewRestaurant_Owner(String wkNum) {
		this.wkNum = wkNum;
		initialize();
	}
		...
		if (btnReview == null) {
			...
			btnReview.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					ModifyRestaurant testReview = new ModifyRestaurant(wkNum);
	...
	private JButton getBtnBack() {
		if (btnBack == null) {
			...
			btnBack.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					frame.setVisible(false);
					SearchRestaurant_Owner searchRestaurant = new SearchRestaurant_Owner();
	...
	private void deleteRestaurant() {
		...
		// 선택창 띄우기
		int result = JOptionPane.showConfirmDialog(null, "해당 식당을 삭제하시겠습니까?", "식당 삭제", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
		
		// yes 누르면 식당 삭제
		if(result == 0) {
			DbActionRestaurant_Owner dbActionRestaurant = new DbActionRestaurant_Owner();
			boolean msg = dbActionRestaurant.deleteAction(wkNum);
			
			if (msg == true) {
				JOptionPane.showMessageDialog(null, "식당 삭제가 완료되었습니다!",
	                  "입력 완료!", 
				...
				JOptionPane.showMessageDialog(null, "식당 삭제에 오류가 발생하였습니다! \n 시스템관리자에 문의하세요!",
	                  "Critical Error!", 
	...
	private void tableClick() {
		...
		int result = JOptionPane.showConfirmDialog(null, "이 메뉴를 삭제하시겠습니까?", "메뉴 삭제", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
		...
		if(result == 0) {
			...
			if (msg == true) {
				...
				JOptionPane.showMessageDialog(null, "메뉴 삭제에 오류가 발생하였습니다! \n 시스템관리자에 문의하세요!",
	                  "Critical Error!", 
	                  JOptionPane.ERROR_MESSAGE);    
			}
		}
