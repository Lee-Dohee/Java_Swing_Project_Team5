...
public class AddressInsert {
	...
	private void check() {
		if(tfName.getText().equals("")) {
			JOptionPane.showMessageDialog(null, "이름을 다시 입력하세요");
		}else if(tfTelno.getText().equals("")) {
			JOptionPane.showMessageDialog(null, "전화번호를 다시 입력하세요");
		}else if(tfAddress.getText().equals("")) {
			JOptionPane.showMessageDialog(null, "주소를 다시 입력하세요");
		}else if(tfEmail.getText().equals("")) {
			JOptionPane.showMessageDialog(null, "이메일을 다시 입력하세요");
		}else if(tfRelation.getText().equals("")) {
			JOptionPane.showMessageDialog(null, "관계를 다시 입력하세요");
		}else{
			insertAction();	
		}
